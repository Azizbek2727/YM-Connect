...
export declare function normalizeProtocolVersion(
...
export declare function fromProtocolError(
  error: ProtocolError,
...
export declare function compareProtocolVersions(
...
export declare function intersectVersionRanges(
  left: VersionRange,
  right: VersionRange,
): VersionRange | undefined;
export declare function selectProtocolVersion(
  local: VersionRange,
  remote: VersionRange,
): ProtocolVersion | undefined;
export declare function assertProtocolCompatible(
  local: VersionRange,
  remote: VersionRange,
): ProtocolVersion;
...
export declare function generateOpaqueId(
  prefix: string,
  byteLength?: number,
  cryptoProvider?: CryptoRandomProvider,
): string;
...
export declare function serializeJsonString<T>(
  schema: MessageSchema<T>,
  message: T,
  options?: unknown,
): string;
export declare function deserializeJsonString<T>(schema: MessageSchema<T>, json: string): T;
export declare function encodeDelimited<T>(
  schema: MessageSchema<T>,
  message: T,
  maxFrameSize?: number,
): Uint8Array;
...
export declare function validateConnectorEnvelope(
  value: ConnectorEnvelope,
  schema?: MessageSchema<ConnectorEnvelope>,
): ConnectorEnvelope;
export declare function validateClientEnvelope(
  value: ClientEnvelope,
  schema?: MessageSchema<ClientEnvelope>,
): ClientEnvelope;
export declare function validateSerializedSize<T>(
  schema: MessageSchema<T>,
  message: T,
  maximum?: number,
): number;
